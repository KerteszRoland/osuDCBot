...
def GetRecentScore(user_id, token):
...
def AddRecentBeatmapScore(user_id):
    score = GetRecentScore(user_id, TOKEN)
    if score == []:
        return None
    score = score[0] 
    stats = {
